 ...
 * GOLDT Loader Class
 *
 * Manages all hooks and filters registration for the plugin.
 *
 ...
 * Class GOLDT_Loader
 *
 * This class maintains all hooks and filters used throughout the plugin.
 * It provides a centralized way to register actions and filters with WordPress.
 *
 * @since 1.0.0
 */
class GOLDT_Loader {
	...
	/**
	 * Utility function to register hooks (actions and filters)
	 *
	 ...
	 *
	 * Run all registered actions and filters with WordPress.
	 *
	 * @since 1.0.0
	 */
	public function run() {
